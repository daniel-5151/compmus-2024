...
# rock_classic <- get_playlist_audio_features("", "3gQy74qNOOC0fYE61ifsqu")
# rock_modern <- get_playlist_audio_features("", "6HnpnVCMacfXlS61xreCzO")
# 
# rock_full <-
#   bind_rows(
...
```{r include=FALSE}
rock_full <- get_playlist_audio_features("", "7rKiaKYREkS2G87cZVmR8X")

# Transform release date string to a date type
rock_full$track.album.release_date <- as.Date(rock_full$track.album.release_date)
