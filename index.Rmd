...
The tempo in this graph yields some interesting results. When it comes to the mean tempoin BPM, Nirvana seems to be overall the highest. Coldplay and The Beatles have around the same median tempo for their tracks. The biggest differences, however, are notable with the variation of different used tempo's throughout each track. Nirvana is again the highest in this regard. But now there is also a difference notable between Coldplay and The Beatles. Coldplay seem to mostly stay around the same tempo throughout their tracks. The Beatles on the other hand have more variation with different tempo's. When further looking at the standard deviations, there seem to be some notable outliers above 5.0 BPM. Let's have a closer look at one of those tracks in the next chapter.  
